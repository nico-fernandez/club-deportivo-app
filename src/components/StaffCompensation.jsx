  ...
  return (
    <div className="p-6">
      ...
      {compensations.length > 0 && (
        <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8 shadow-sm">
          <h3 className="text-lg font-semibold mb-4">Compensaciones Manuales Adicionales</h3>
          <div className="space-y-3">
            {compensations.map((compensation) => (
              <div key={compensation.id} className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                <div className="flex justify-between items-center">
                  <div>
                    <div className="font-semibold text-gray-900">{compensation.staffName}</div>
                    <div className="text-sm text-gray-600">{compensation.description}</div>
                    <div className="text-xs text-gray-500">{compensation.date}</div>
                  </div>
                  <div className="text-right">
                    <div className="font-bold text-green-600">{compensation.amount}</div>
                    <div className="text-xs text-blue-600 capitalize">{compensation.type}</div>
                  </div>
                </div>
              </div>
            ))}
      ...
      {showDetails && (
        <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
          <h3 className="text-lg font-semibold mb-4">Detalles del Sistema de Compensaciones</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <div className="bg-blue-50 p-4 rounded-lg">
                <h4 className="font-semibold text-blue-800 mb-2">Cálculo Automatizado</h4>
                <ul className="text-sm text-blue-700 space-y-1">
                  <li>• 70% de los ingresos por inscripciones</li>
                  <li>• 30% para el club (gastos operativos)</li>
                  <li>• Cálculo en tiempo real</li>
                  <li>• Sin necesidad de aprobación manual</li>
                </ul>
              </div>
              
              <div className="bg-green-50 p-4 rounded-lg">
                <h4 className="font-semibold text-green-800 mb-2">Compensaciones Manuales</h4>
                <ul className="text-sm text-green-700 space-y-1">
                  <li>• Bonos por rendimiento</li>
                  <li>• Compensaciones especiales</li>
                  <li>• Requieren aprobación del administrador</li>
                  <li>• Se suman al total automático</li>
                </ul>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="bg-yellow-50 p-4 rounded-lg">
                <h4 className="font-semibold text-yellow-800 mb-2">Factores de Cálculo</h4>
                <ul className="text-sm text-yellow-700 space-y-1">
                  <li>• Número de inscripciones por clase</li>
                  <li>• Cuota de inscripción establecida</li>
                  <li>• Período de facturación</li>
                  <li>• Estado de la clase (activa/completada)</li>
                </ul>
              </div>
              
              <div className="bg-purple-50 p-4 rounded-lg">
                <h4 className="font-semibold text-purple-800 mb-2">Proceso de Pago</h4>
                <ul className="text-sm text-purple-700 space-y-1">
                  <li>• Cálculo automático mensual</li>
                  <li>• Revisión por el administrador</li>
                  <li>• Aprobación y registro de pago</li>
